...
order: 4
tag: "SOLO · INFRA"
summary: "GPU 없는 환경에서 Isaac Sim의 원격 GUI를 띄우면서 부딪힌 막힘들을, 팀이 같은 자리에서 다시 헤매지 않도록 다이어그램으로 정리한 작업"
...
저는 클라우드 GPU나 WebRTC를 처음부터 잘 알고 시작한 게 아니었습니다. 결과적으로 만들어진 것은 화려한 아키텍처가 아니라, **이 환경에 들어올 다음 사람이 같은 자리에서 며칠을 헤매지 않게 하는 한 장의 지도**입니다.
